...
|---------|-------------|----------|-------|--------------|--------|
| [OCCT](https://github.com/Open-Cascade-SAS/OCCT) | Open CASCADE Technology (OCCT) is an open-source software development platform for 3D CAD, CAM, CAE. | C++ | 1705 | Aug 12, 2025 | LGPL-2.1 |
...
| [three.js](https://github.com/mrdoob/three.js) | JavaScript 3D Library. | JavaScript | 108066 | Aug 13, 2025 | MIT |
...
| [QGIS](https://github.com/qgis/QGIS) | QGIS is a free, open source, cross platform (lin/win/mac) geographical information system (GIS) | C++ | 11645 | Aug 12, 2025 | GPL-2.0 |
...
| [IfcOpenShell](https://github.com/ifcopenshell/ifcopenshell) | Open source IFC library and geometry engine | C++ | 2178 | Aug 12, 2025 | LGPL-3.0 |
...
| [ifc-flow](https://github.com/louistrue/ifc-flow) | A visual node-based tool for working with Industry Foundation Classes (IFC) files | TypeScript | 39 | Aug 12, 2025 | AGPL-3.0 |
