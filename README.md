...
|---------|-------------|----------|-------|--------------|--------|
| [OCCT](https://github.com/Open-Cascade-SAS/OCCT) | Open CASCADE Technology (OCCT) is an open-source software development platform for 3D CAD, CAM, CAE. | C++ | 1657 | Jul 11, 2025 | LGPL-2.1 |
...
| [three.js](https://github.com/mrdoob/three.js) | JavaScript 3D Library. | JavaScript | 107547 | Jul 11, 2025 | MIT |
...
| [QGIS](https://github.com/qgis/QGIS) | QGIS is a free, open source, cross platform (lin/win/mac) geographical information system (GIS) | C++ | 11529 | Jul 11, 2025 | GPL-2.0 |
| [rhino3dm](https://github.com/mcneel/rhino3dm) | Libraries based on OpenNURBS with a RhinoCommon style | C# | 667 | Jul 11, 2025 | MIT |
...
| [IfcOpenShell](https://github.com/ifcopenshell/ifcopenshell) | Open source IFC library and geometry engine | C++ | 2149 | Jul 11, 2025 | LGPL-3.0 |
| [xeokit-sdk](https://github.com/xeokit/xeokit-sdk) | 3D BIM IFC Viewer SDK for AEC engineering applications. Open Source JavaScript Toolkit based on pure WebGL for top performance, real-world coordinates and full double precision | JavaScript | 805 | Jul 11, 2025 | AGPL-3.0 |
...
| [honeybee-energy](https://github.com/ladybug-tools/honeybee-energy) | 🐝 :fire: Honeybee extension for energy simulation | Python | 33 | Jul 10, 2025 | AGPL-3.0 |
| [dragonfly-core](https://github.com/ladybug-tools/dragonfly-core) | :dragon: dragonfly core library | Python | 18 | Jul 9, 2025 | AGPL-3.0 |
...
| [engine_web-ifc](https://github.com/ThatOpen/engine_web-ifc) | Reading and writing IFC files with Javascript, at native speeds. | TypeScript | 753 | Jul 11, 2025 | MPL-2.0 |
...
| [web-ifc-viewer](https://github.com/ThatOpen/web-ifc-viewer) | Graphics engine and toolkit for client applications. | JavaScript | 976 | Jul 11, 2025 | MIT |
| [ifc-classifier](https://github.com/louistrue/ifc-classifier) | No description provided | TypeScript | 8 | Jul 11, 2025 | AGPL-3.0 |
...
| [ara3d-sdk](https://github.com/ara3d/ara3d-sdk) | 📚 Various C# libraries for efficient data driven applications  | C# | 8 | Jul 10, 2025 | MIT |
| [ara3d-webgl](https://github.com/ara3d/ara3d-webgl) | A Three.JS based WebGL viewer for AEC data.  | TypeScript | 24 | Jul 7, 2025 | MIT |
| [gladis](https://github.com/daikon-eco/gladis) | A web app and search engine for Environmental Product Declarations (EPDs). | Python | 3 | Jul 10, 2025 | AGPL-3.0 |
...
| [bowerbird](https://github.com/ara3d/bowerbird) | Scripted C# Plug-in Framework for Revit | C# | 51 | Jul 10, 2025 | MIT |
| [awesome-point-cloud-processing](https://github.com/mmolero/awesome-point-cloud-processing) | A curated list of awesome Point Cloud Processing Resources, Libraries, Software | N/A | 769 | Jul 4, 2025 | CC0-1.0 |
